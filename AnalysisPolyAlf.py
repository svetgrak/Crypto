...
class Ui_AnalysisPolyAlf(object):
    def setupUi(self, AnalysisPolyAlf):
        ...
        AnalysisPolyAlf.resize(650, 700)
        AnalysisPolyAlf.setMinimumSize(QtCore.QSize(650, 700))
        AnalysisPolyAlf.setMaximumSize(QtCore.QSize(650, 700))
        ...
        self.tableWidget_2.setGeometry(QtCore.QRect(460, 10, 120, 191))
        ...
        self.pushButton.setGeometry(QtCore.QRect(440, 210, 191, 25))
        ...
        self.tableWidget_3.setGeometry(QtCore.QRect(30, 540, 201, 111))
        ...
        self.tableWidget_4.setGeometry(QtCore.QRect(390, 500, 201, 151))
        ...
        self.tableWidget_5.setGeometry(QtCore.QRect(460, 270, 121, 191))
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(280, 310, 141, 25))
        self.pushButton_4.setObjectName("pushButton_4")
        self.tableWidget_6 = QtWidgets.QTableWidget(self.centralwidget)
        self.tableWidget_6.setGeometry(QtCore.QRect(280, 340, 121, 91))
...
def methodKasiski(text,count_symb):

    text = text_del_symb(text)
    array_positions = index_double_row(text,count_symb)

    result = []
    result.append(create_dict_double(text,count_symb))

    array_gcds = []

    for positions in array_positions:
        array_diff = []
        for i in range(len(positions)-1):array_diff.append(positions[i+1]-positions[i])

        for i in range(len(array_diff)-1):
            if gcd(array_diff[i],array_diff[i+1]) !=1:
                array_gcds.append(gcd(array_diff[i],array_diff[i+1]))
    result.append(freq_len_key(array_gcds))
